...
function applyBrandingAndUi(source){
  ...
  html=html.replace('</style>',`.official-yepii-logo{display:block;width:150px;max-width:100%;height:auto;object-fit:contain}.footer-yepii-logo{width:105px}.receipt-logo-img{display:block;width:120px;height:auto;object-fit:contain}@media(max-width:640px){.official-yepii-logo{width:130px}}@media print{.receipt-logo-img{width:110px!important;height:auto!important}}\n</style>`);
